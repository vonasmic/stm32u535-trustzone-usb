        ...
        CK_SESSION_HANDLE_PTR phSession)
{
    struct C_OpenSession_nsc_args args = {
        ...
        .pApplication = pApplication, .Notify = Notify,
        .phSession = phSession
    };
        ...
        CK_OBJECT_HANDLE hEncryptionKey, CK_OBJECT_HANDLE hAuthenticationKey)
{
    struct C_SetOperationState_nsc_args args = {
        .hSession = hSession, .pOperationState = pOperationState,
        .ulOperationStateLen = ulOperationStateLen,
        .hEncryptionKey = hEncryptionKey, .hAuthenticationKey = hAuthenticationKey
    };
        ...
        CK_OBJECT_HANDLE_PTR phNewObject)
{
    struct C_CopyObject_nsc_args args = {
        .hSession = hSession, .hObject = hObject,
        .pTemplate = pTemplate, .ulCount = ulCount, .phNewObject = phNewObject
    };
        ...
        CK_ULONG_PTR pulEncryptedDataLen)
{
    struct C_Encrypt_nsc_args args = {
        .hSession = hSession, .pData = pData, .ulDataLen = ulDataLen,
        .pEncryptedData = pEncryptedData, .pulEncryptedDataLen = pulEncryptedDataLen
    };
        ...
        CK_ULONG_PTR pulEncryptedPartLen)
{
    struct C_EncryptUpdate_nsc_args args = {
        .hSession = hSession, .pPart = pPart, .ulPartLen = ulPartLen,
        .pEncryptedPart = pEncryptedPart, .pulEncryptedPartLen = pulEncryptedPartLen
    };
        ...
        CK_ULONG_PTR pulDataLen)
{
    struct C_Decrypt_nsc_args args = {
        .hSession = hSession, .pEncryptedData = pEncryptedData,
        .ulEncryptedDataLen = ulEncryptedDataLen,
        .pData = pData, .pulDataLen = pulDataLen
    };
        ...
        CK_BYTE_PTR pPart, CK_ULONG_PTR pulPartLen)
{
    struct C_DecryptUpdate_nsc_args args = {
        .hSession = hSession, .pEncryptedPart = pEncryptedPart,
        .ulEncryptedPartLen = ulEncryptedPartLen,
        .pPart = pPart, .pulPartLen = pulPartLen
    };
        ...
        CK_ULONG ulDataLen, CK_BYTE_PTR pDigest, CK_ULONG_PTR pulDigestLen)
{
    struct C_Digest_nsc_args args = {
        .hSession = hSession, .pData = pData, .ulDataLen = ulDataLen,
        .pDigest = pDigest, .pulDigestLen = pulDigestLen
    };
        ...
        CK_ULONG_PTR pulSignatureLen)
{
    struct C_Sign_nsc_args args = {
        .hSession = hSession, .pData = pData, .ulDataLen = ulDataLen,
        .pSignature = pSignature, .pulSignatureLen = pulSignatureLen
    };
        ...
        CK_ULONG ulDataLen, CK_BYTE_PTR pSignature, CK_ULONG ulSignatureLen)
{
    struct C_Verify_nsc_args args = {
        .hSession = hSession, .pData = pData, .ulDataLen = ulDataLen,
        .pSignature = pSignature, .ulSignatureLen = ulSignatureLen
    };
        ...
        CK_BYTE_PTR pData, CK_ULONG_PTR pulDataLen)
{
    struct C_VerifyRecover_nsc_args args = {
        .hSession = hSession, .pSignature = pSignature,
        ...
        CK_OBJECT_HANDLE_PTR phKey)
{
    struct C_GenerateKey_nsc_args args = {
        .hSession = hSession, .pMechanism = pMechanism,
        .pTemplate = pTemplate, .ulCount = ulCount, .phKey = phKey
    };
        ...
        CK_OBJECT_HANDLE_PTR phPublicKey, CK_OBJECT_HANDLE_PTR phPrivateKey)
{
    struct C_GenerateKeyPair_nsc_args args = {
        ...
        .phPublicKey = phPublicKey, .phPrivateKey = phPrivateKey
    };
        ...
        CK_BYTE_PTR pWrappedKey, CK_ULONG_PTR pulWrappedKeyLen)
{
    struct C_WrapKey_nsc_args args = {
        .hSession = hSession, .pMechanism = pMechanism,
        .hWrappingKey = hWrappingKey, .hKey = hKey,
        .pWrappedKey = pWrappedKey, .pulWrappedKeyLen = pulWrappedKeyLen
    };
        ...
        CK_OBJECT_HANDLE_PTR phKey)
{
    struct C_UnwrapKey_nsc_args args = {
        ...
        .pWrappedKey = pWrappedKey, .ulWrappedKeyLen = ulWrappedKeyLen,
        .pTemplate = pTemplate, .ulAttributeCount = ulAttributeCount, .phKey = phKey
    };
        ...
        CK_OBJECT_HANDLE_PTR phKey)
{
    struct C_DeriveKey_nsc_args args = {
        .hSession = hSession, .pMechanism = pMechanism, .hBaseKey = hBaseKey,
        .pTemplate = pTemplate, .ulAttributeCount = ulAttributeCount, .phKey = phKey
    };
